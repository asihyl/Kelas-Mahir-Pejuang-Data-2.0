...
str(df)
```
Karena pada kolom Cabin terdapat elemen "" maka kita anggap itu termasuk data kosong, jadi kita ubah dulu ke NA
...
## Memilih Variabel Target & Variabel Independent
```{r}
y=df$Survived
